...
public class SimulationConfiguration {
        ...
        public static UserLocationScenario USER_LOCATION_SCENARIO = UserLocationScenario.READ;
        ...
        public static String USER_LOCATION_FILE_NAME = "user100-map900-step10000.json";
        // public static String USER_LOCATION_FILE = "src/dist/get_scenario/postions/" +
        // USER_LOCATION_FILE_NAME;
        public static String USER_LOCATION_FILE = "/home/tsuyohase/lab/iij/CMorph2/src/dist/get_scenario/positions/user100-map900-step10000.json";
        ...
        public static final int AVE_JOB_TIME_SLOT = 16;
        ...
        public static final int DATA_CENTER_NUM = 10;;
        public static double TOTAL_LOAD_RATE = 0.4;
        ...
        public static final boolean RANDOM_DC_LOCATION = true;
        ...
        // AllocationServer
        public static LoadCostFunctionType LOAD_COST_FUNCTION_TYPE = LoadCostFunctionType.MONOTONIC;
        ...
        public static int POW_FOR_NETWORK = 1;
        // public static final double NETWORK_DISTANCE_THRESHOLD = 2 * MAP_WIDTH /
        // (Math.sqrt(DATA_CENTER_NUM) + 1);
        public static final double NETWORK_DISTANCE_THRESHOLD = 150;
                                ...
                                case "-scenario":
                                        if (i + 1 < args.length) {
                                                if (args[i + 1].equals("random")) {
                                                        ...
                                                        fileName += "centerLeft";
                                                } else if (args[i + 1].equals("read")) {
                                                        USER_LOCATION_SCENARIO = UserLocationScenario.READ;
                                                        fileName += "read";
                                                }
                                                i++;
                                        }
